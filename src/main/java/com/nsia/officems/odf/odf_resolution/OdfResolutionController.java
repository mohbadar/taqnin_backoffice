...
public class OdfResolutionController {
    ...
    public Object getFilesList(@RequestBody String requestBody) throws Exception {
        ...
        try {
            return odfResolutionService.getList(input, filters);
        } catch (Exception e) {
    ...
    public List<OdfResolution> findAll() {
        return odfResolutionService.findAll();
    }

    @GetMapping(path = { "/{id}" })
    public OdfResolution findById(@PathVariable("id") Long id) {
        return odfResolutionService.findById(id);
    }

    @PostMapping(value = "/create")
    public OdfResolution create(@RequestBody OdfResolutionDto createResolutionDto) {
        return odfResolutionService
                .create(OdfResolutionMapper.MapResolutionDto(new OdfResolution(), createResolutionDto, shuraService));
    }

    @PostMapping(value = "/update/{id}")
    public Boolean update(@PathVariable("id") Long id, @RequestBody OdfResolutionDto odfResolutionDto) {
        return odfResolutionService.update(id, odfResolutionDto);
    }
